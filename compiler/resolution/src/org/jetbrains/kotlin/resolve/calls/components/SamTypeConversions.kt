    ...
    override fun conversionIsNeededBeforeSubtypingCheck(
        ...
        return when (argument) {
            is SubKotlinCallArgument -> {
                ...
                if (stableType.isFunctionType || (areSuspendOnlySamConversionsSupported && stableType.isFunctionOrSuspendFunctionType))
                    return true
            ...
            is SimpleKotlinCallArgument -> argument.receiver.stableType.run {
                isFunctionType || (areSuspendOnlySamConversionsSupported && isFunctionOrSuspendFunctionType)
            }
